...
// Same socials + copy as the old General-Website footer, drawn with inline brand glyphs
// (coloured via the theme foreground) so they sit cleanly on the light page.
const SOCIALS = [
  {
    label: 'GitHub',
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/cu-physical-intelligence/',
