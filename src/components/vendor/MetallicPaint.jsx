/* MetallicPaint — vendored from React Bits (https://reactbits.dev/animations/metallic-paint)
 *
 * Copyright (c) 2026 David Haz
 * MIT + Commons Clause License Condition v1.0
 * https://github.com/DavidHDev/react-bits/blob/main/LICENSE.md
 *
 * Unmodified apart from this header and the CSS import path. Drives the tier names on the
 * Sponsors page; see MetalWord.jsx for how the word is turned into the mask it fills.
 */
